...
* [Swagger API Docs Cambio Service - http://localhost:8000/cambio-service/v3/api-docs](http://localhost:8000/v3/api-docs)
...
* [Swagger API Docs Book Service - http://localhost:8100/book-service/v3/api-docs](http://localhost:8100/v3/api-docs)
